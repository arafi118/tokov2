...
Route::get('admin/login', [App\Http\Controllers\Auth\LoginAdminController::class, 'showLoginForm'])->name('admin.login');
Route::post('admin/login', [App\Http\Controllers\Auth\LoginAdminController::class, 'doLogin'])->name('admin.login');

Route::group(['middleware' => ['auth:admin']], function () {
	Route::get('admin/home', [App\Http\Controllers\AdminController::class, 'index'])->name('admin.home');
	Route::get('admin/logout', [App\Http\Controllers\Auth\LoginAdminController::class, 'logout'])->name('admin.logout');
	Route::get('admin/tenant', [App\Http\Controllers\Admin\TenantController::class, 'index'])->name('admin.tenant');
	Route::post('admin/tenant/getdata', [App\Http\Controllers\Admin\TenantController::class, 'getData'])->name('admin.tenant.getdata');
	Route::get('admin/tenant/create', [App\Http\Controllers\Admin\TenantController::class, 'create'])->name('admin.tenant.create');
	Route::get('admin/tenant/edit/{id}', [App\Http\Controllers\Admin\TenantController::class, 'edit'])->name('admin.tenant.edit');
	Route::post('admin/tenant/store', [App\Http\Controllers\Admin\TenantController::class, 'store'])->name('admin.tenant.store');
	Route::post('admin/tenant/update/{id}', [App\Http\Controllers\Admin\TenantController::class, 'update'])->name('admin.tenant.update');
	Route::get('admin/tenant/delete', [App\Http\Controllers\Admin\TenantController::class, 'delete'])->name('admin.tenant.delete');
});
...
Route::group(['middleware' => ['common', 'auth:web', 'active']], function () {
	...
	Route::get('sales/add_payment_cicilan', 'SaleController@formAddPaymentCicilan')->name('sale.add-payment-cicilan');
	Route::post('sales/add_payment_cicilan', 'SaleController@addPaymentCicilan')->name('sale.add-payment-cicilan');
	...
	Route::get('purchases/add_payment_cicilan', 'PurchaseController@formAddPaymentCicilan')->name('purchase.add-payment-cicilan');
	Route::post('purchases/add_payment_cicilan', 'PurchaseController@addPaymentCicilan')->name('purchase.add-payment-cicilan');
	...
	Route::get('accounts/impor_saldo_awal', 'AccountsController@formSaldoAwal')->name('accounts.impor_saldo_awal');
	Route::get('accounts/format_saldo_awal', 'AccountsController@formatSaldoAwal')->name('accounts.format_saldo_awal');
	Route::post('accounts/impor_saldo_awal', 'AccountsController@imporSaldoAwal')->name('accounts.impor_saldo_awal');
	...
	Route::post('jurnal/store', 'JurnalController@store')->name('jurnal.store');
	Route::get('jurnal/edit/{id}', 'JurnalController@edit')->name('jurnal.edit');
	Route::get('jurnal/detail/{id}', 'JurnalController@detail')->name('jurnal.detail');
	Route::get('jurnal/getjenistransaksi', 'JurnalController@getJenisTransaksi')->name('jurnal.getjenistransaksi');
	Route::delete('jurnal/destroy/{id}', 'JurnalController@destroy')->name('jurnal.destroy');

	Route::get('tutup_buku', 'TutupBukuController@index')->name('tutup_buku.index');
	Route::post('tutup_buku/submit', 'TutupBukuController@submit')->name('tutup_buku.submit');
	//HRM routes
	...
	//laporan keuangan
	Route::get('laporan_keuangan', 'LaporanKeuanganController@index')->name('laporan_keuangan');
	Route::get('laporan_keuangan/jurnal', 'LaporanKeuanganController@jurnal')->name('laporan_keuangan.jurnal');
	Route::get('laporan_keuangan/buku_besar', 'LaporanKeuanganController@bukuBesar')->name('laporan_keuangan.buku_besar');
	Route::get('laporan_keuangan/neraca', 'LaporanKeuanganController@neraca')->name('laporan_keuangan.neraca');
	Route::get('laporan_keuangan/neraca_saldo', 'LaporanKeuanganController@neracaSaldo')->name('laporan_keuangan.neraca_saldo');
	Route::get('laporan_keuangan/rugi_laba', 'LaporanKeuanganController@rugiLaba')->name('laporan_keuangan.rugi_laba');
	Route::get('laporan_keuangan/arus_kas', 'LaporanKeuanganController@arusKas')->name('laporan_keuangan.arus_kas');
	Route::get('laporan_keuangan/inventaris', 'LaporanKeuanganController@inventaris')->name('laporan_keuangan.inventaris');
});
