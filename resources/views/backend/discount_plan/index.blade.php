    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-end">
                <a href="{{ route('discount-plans.create') }}" class="btn btn-info">
                    <i class="dripicons-plus"></i> {{ trans('file.Create Discount Plan') }}
                </a>
            </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                            user="menu">
                                            <li>
                                                <a href="{{ route('discount-plans.edit', $discount_plan->id) }}"
