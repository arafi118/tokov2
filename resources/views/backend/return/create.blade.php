                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($lims_product_sale_data as $product_sale)
                                                            <tr>
                                                                <?php
                                                                $product_data = DB::connection(env('TENANT_DB_CONNECTION'))
                                                                    ->table('products')
                                                                ...
                                                                $tax = DB::connection(env('TENANT_DB_CONNECTION'))
                                                                    ->table('taxes')
                                                                    ->where('rate', $product_sale->tax_rate)
                                                                    ->first();
                                                                if ($product_data->type == 'standard') {
                                                                    $unit = DB::connection(env('TENANT_DB_CONNECTION'))
                                                                        ->table('units')
                                                                        ->select('unit_name')
                                                                        ->find($product_data->unit_id);
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="actual_qty[]"
                                                                        class="actual-qty"
                                                                        value="{{ $product_sale->qty }}">
                                                                    <input type="number" class="form-control qty"
                                                                        name="qty[]" value="{{ $product_sale->qty }}"
                                                                        required step="any"
                                                                        max="{{ $product_sale->qty }}" />
                                                                </td>
                                                                <td class="net_unit_price">
                                                                    {{ number_format((float) $product_sale->net_unit_price, 2, '.', '') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_sale->discount, 2, '.', '') }}
                                                                </td>
                                                                <td class="cashback">
                                                                    {{ number_format((float) $product_sale->cashback, 2, '.', '') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_sale->tax, 2, '.', '') }}
                                                                </td>
                                                                <td class="sub-total">
        ...
        function calculateTotal() {
            ...
            $(".is-return").each(function(i) {
                if ($(this).is(":checked")) {
                    ...
                    var cashback = $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .cashback').text();
                    ...
                    total_cashback += parseFloat(cashback);
                    ...
                    $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .sub-total').text(parseFloat(
