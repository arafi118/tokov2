						      	...
						      	<tr>
						            ...
						            <td class="report-permissions" colspan="5">
						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	@if(in_array("account-report", $all_permission))
							                    	<input type="checkbox" value="1" id="account-report-permission" name="account-report" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="account-report-permission" name="account-report">
							                    	@endif
								                    <label for="account-report-permission" class="padding05">Account Report &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	@if(in_array("account-journal", $all_permission))
							                    	<input type="checkbox" value="1" id="account-journal-permission" name="account-journal" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="account-journal-permission" name="account-journal">
							                    	@endif
								                    <label for="account-journal-permission" class="padding05">Account Journal &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	@if(in_array("account-close-statement", $all_permission))
							                    	<input type="checkbox" value="1" id="account-close-statement-permission" name="account-close-statement" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="account-close-statement-permission" name="account-close-statement">
							                    	@endif
								                    <label for="account-close-statement-permission" class="padding05">Account Close Statement &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
