...
<html dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif">
  ...
  <body @if($theme == 'dark') class="dark-mode dripicons-brightness-low" @else class="" @endif onload="myFunction()">
    <?php $role = DB::connection(env('TENANT_DB_CONNECTION'))->table('roles')->find(Auth::user()->role_id); ?>
    <div id="loader"></div>
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.Quotation')}}</span><span></a>
                <ul id="quotation" class="collapse list-unstyled ">
                    <li id="quotation-list-menu"><a href="{{route('quotations.index')}}">
                    <li id="quotation-create-menu"><a href="{{route('quotations.create')}}">{{trans('file.Add Quotation')}}</a></li>
                </ul>
            </li>
            <li>
                <a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-export"></i><span>{{trans('file.Transfer')}}</span></a>
            ...
            <li>
                <a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-return"></i><span>{{trans('file.return')}}</span></a>
            ...
            <li class="">
                ...
                <ul id="account" class="collapse list-unstyled ">
                    ...
                    <li id="jurnal-menu"><a href="{{route('jurnal.index')}}">Jurnal</a></li>
                    <li id="laporan-keuangan-menu"><a href="{{route('laporan_keuangan')}}">Laporan Keuangan</a></li>
                    <li id="tutup-buku-menu"><a href="{{route('tutup_buku.index')}}">Tutup Buku</a></li>
                </ul>
            </li>
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    <?php
                        $all_notification_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                        ...
                        $send_notification_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $warehouse_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $customer_group_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $brand_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $unit_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $currency_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $tax_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $general_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $backup_database_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $mail_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $sms_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $create_sms_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $pos_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $hrm_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $reward_point_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $discount_plan_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
                        ...
                        $discount_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                            ->where([
    ...
    <div class="page">
      ...
      <header class="container-fluid">
            <nav class="navbar">
                ...
                <?php
                    $empty_database_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([
