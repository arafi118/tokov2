          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              <li><a href="{{url('/')}}"> <i class="dripicons-meter"></i><span>{{ __('file.dashboard') }}</span></a></li>
               <?php
                  $role = DB::connection(env('TENANT_DB_CONNECTION'))->table('roles')->find(Auth::user()->role_id);
                  $category_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'category'],
                        ['role_id', $role->id] ])->first();
                  $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'products-index')->first();
                  $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                      ['permission_id', $index_permission->id],
                      ['role_id', $role->id]
                  ])->first();

                  $print_barcode = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'print_barcode')->first();
                      $print_barcode_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $print_barcode->id],
                          ['role_id', $role->id]
                      ])->first();

                  $stock_count = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'stock_count')->first();
                      $stock_count_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $stock_count->id],
                          ['role_id', $role->id]
                      ])->first();

                    $adjustment = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'adjustment')->first();
                    $adjustment_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{__('file.product')}}</span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'products-add')->first();
                    $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'purchases-index')->first();
                  $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>{{trans('file.Purchase')}}</span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'purchases-add')->first();
                    $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @endif
              <?php 
                $sale_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'sales-index')->first();
                $sale_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $sale_index_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $gift_card_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'gift_card')->first();
                $gift_card_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $gift_card_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $coupon_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'coupon')->first();
                $coupon_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $coupon_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $delivery_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'delivery'],
                        ['role_id', $role->id] ])->first();

                $sale_add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'sales-add')->first();
                $sale_add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'expenses-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-wallet"></i><span>{{trans('file.Expense')}}</span></a>
                <ul id="expense" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'expenses-add')->first();
                    $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'quotes-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.Quotation')}}</span><span></a>
                <ul id="quotation" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'quotes-add')->first();
                    $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'transfers-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-export"></i><span>{{trans('file.Transfer')}}</span></a>
                <ul id="transfer" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'transfers-add')->first();
                    $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php 
                $sale_return_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'returns-index')->first();
                
                $sale_return_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $sale_return_index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
                
                $purchase_return_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'purchase-return-index')->first();
                
                $purchase_return_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'account-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $money_transfer_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'money-transfer')->first();
                $money_transfer_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $money_transfer_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $balance_sheet_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'balance-sheet')->first();
                $balance_sheet_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $balance_sheet_permission->id],
                        ['role_id', $role->id]
                    ])->first();

                $account_statement_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'account-statement')->first();
                $account_statement_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              @endif
              <?php 
                $department = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'department')->first();
                $department_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $department->id],
                        ['role_id', $role->id]
                    ])->first();
                $index_employee = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'employees-index')->first();
                $index_employee_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_employee->id],
                        ['role_id', $role->id]
                    ])->first();
                $attendance = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'attendance')->first();
                $attendance_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $attendance->id],
                        ['role_id', $role->id]
                    ])->first();
                $payroll = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'payroll')->first();
                $payroll_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              <?php 
                  $user_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'users-index'],
                        ['role_id', $role->id] ])->first();

                  $customer_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'customers-index')->first();
                  
                  $customer_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                            ['permission_id', $customer_index_permission->id],
                            ['role_id', $role->id]
                        ])->first();

                  $biller_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'billers-index')->first();
                  
                  $biller_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                            ['permission_id', $biller_index_permission->id],
                            ['role_id', $role->id]
                        ])->first();

                  $supplier_index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'suppliers-index')->first();
                  
                  $supplier_index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>{{trans('file.People')}}</span></a>
                <ul id="people" class="collapse list-unstyled ">
                  ...
                  <?php $user_add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([
                  ...
                  <?php 
                    $customer_add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'customers-add')->first();
                    $customer_add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                  ...
                  <?php 
                    $biller_add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'billers-add')->first();
                    $biller_add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                  ...
                  <?php 
                    $supplier_add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'suppliers-add')->first();
                    $supplier_add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
              ...
              <?php
                $profit_loss_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'profit-loss'],
                        ['role_id', $role->id] ])->first();
                $best_seller_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'best-seller'],
                        ['role_id', $role->id] ])->first();
                $warehouse_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'warehouse-report'],
                        ['role_id', $role->id] ])->first();
                $warehouse_stock_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'warehouse-stock-report'],
                        ['role_id', $role->id] ])->first();
                $product_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'product-report'],
                        ['role_id', $role->id] ])->first();
                $daily_sale_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'daily-sale'],
                        ['role_id', $role->id] ])->first();
                $monthly_sale_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'monthly-sale'],
                        ['role_id', $role->id]])->first();
                $daily_purchase_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'daily-purchase'],
                        ['role_id', $role->id] ])->first();
                $monthly_purchase_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'monthly-purchase'],
                        ['role_id', $role->id] ])->first();
                $purchase_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'purchase-report'],
                        ['role_id', $role->id] ])->first();
                $sale_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'sale-report'],
                        ['role_id', $role->id] ])->first();
                $payment_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'payment-report'],
                        ['role_id', $role->id] ])->first();
                $product_qty_alert_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'product-qty-alert'],
                        ['role_id', $role->id] ])->first();
                $user_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'user-report'],
                        ['role_id', $role->id] ])->first();

                $customer_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'customer-report'],
                        ['role_id', $role->id] ])->first();
                $supplier_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
                        ['permissions.name', 'supplier-report'], 
                        ['role_id', $role->id] ])->first();
                $due_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                      ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                      ->where([
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                  <?php
                      $send_notification_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'send_notification')->first();
                      $send_notification_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $send_notification_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $warehouse_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'warehouse')->first();
                      $warehouse_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $warehouse_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $customer_group_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'customer_group')->first();
                      $customer_group_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $customer_group_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $brand_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'brand')->first();
                      $brand_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $brand_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $unit_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'unit')->first();
                      $unit_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $unit_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $currency_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'currency')->first();
                      $currency_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $currency_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $tax_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'tax')->first();
                      $tax_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $tax_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $general_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'general_setting')->first();
                      $general_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $general_setting_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $backup_database_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'backup_database')->first();
                      $backup_database_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                  ['permission_id', $backup_database_permission->id],
                                  ['role_id', $role->id]
                              ])->first();

                      $mail_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'mail_setting')->first();
                      $mail_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $mail_setting_permission->id],
                          ['role_id', $role->id]
                      ])->first();

                      $sms_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'sms_setting')->first();
                      $sms_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $sms_setting_permission->id],
                          ['role_id', $role->id]
                      ])->first();

                      $create_sms_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'create_sms')->first();
                      $create_sms_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $create_sms_permission->id],
                          ['role_id', $role->id]
                      ])->first();

                      $pos_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'pos_setting')->first();
                      $pos_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $pos_setting_permission->id],
                          ['role_id', $role->id]
                      ])->first();

                      $hrm_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'hrm_setting')->first();
                      $hrm_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                          ['permission_id', $hrm_setting_permission->id],
                          ['role_id', $role->id]
                      ])->first();

                      $reward_point_setting_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'reward_point_setting')->first();
                      $reward_point_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <?php 
                  $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'sales-add')->first();
                  $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                      ['permission_id', $add_permission->id],
                      ['role_id', $role->id]
                  ])->first();

                  $empty_database_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'empty_database')->first();
                  $empty_database_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                ...
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    {!! Form::open(['route' => 'notifications.store', 'method' => 'post']) !!}
                      <div class="row">
                          <?php 
                              $lims_user_list = DB::connection(env('TENANT_DB_CONNECTION'))->table('users')->where([
                                ['is_active', true],
                                ['id', '!=', \Auth::user()->id]
                              ])->get();
                          ?>
                ...
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    ...
                    <?php 
                      ...
                      if(Auth::user()->role_id > 2)
                        $lims_warehouse_list = DB::connection(env('TENANT_DB_CONNECTION'))->table('warehouses')->where([
                          ['is_active', true],
