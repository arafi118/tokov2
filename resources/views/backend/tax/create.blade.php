        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-end">
                <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info">
                    <i class="dripicons-plus"></i> {{ trans('file.Add Tax') }}
                </a>
                {{-- <a href="#" data-toggle="modal" data-target="#importTax" class="btn btn-primary">
                    <i class="dripicons-copy"></i> {{ trans('file.Import Tax') }}
                </a> --}}
            </div>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{ trans('file.The correct column order is') }} (name*, rate*)
