    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-end">
                <a href="{{ route('accounts.create') }}" class="btn btn-info">
                    <i class="dripicons-plus"></i>
                    {{ trans('file.Add Account') }}
                </a>
                {{-- <a href="{{ route('accounts.impor_saldo_awal') }}" class="btn btn-danger">
                    <i class="dripicons-export"></i> Impor Saldo Awal
                </a> --}}
            </div>
                                ...
                                <td style="text-align:center;">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                            user="menu">
                                            <li><a href="{{ route('accounts.edit', ['account' => $account->id]) }}"><button
