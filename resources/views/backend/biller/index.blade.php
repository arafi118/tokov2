        ...
        <div class="container-fluid">
            @if (in_array('billers-add', $all_permission))
                <div class="d-flex justify-content-end">
                    <a href="{{ route('biller.create') }}" class="btn btn-info">
                        <i class="dripicons-plus"></i> {{ trans('file.Add Biller') }}
                    </a>
                    {{-- <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary">
                <i class="dripicons-copy"></i> {{trans('file.Import Biller')}}
            </a> --}}
                </div>
            @endif
                    ...
                    <tbody>
                        @foreach ($lims_biller_all as $key => $biller)
                            <tr data-id="{{ $biller->id }}">
                                <td>{{ $key }}</td>
                                @if ($biller->image)
                                    <td> <img src="{{ url('public/images/biller', $biller->image) }}" height="80"
                                            width="80">
                                    </td>
                                @else
                                    <td>No Image</td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                            ...
                                            @if (in_array('billers-edit', $all_permission))
                                                <li>
                                                    <a href="{{ route('biller.edit', $biller->id) }}"
