                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <?php
                                                        $product_data = DB::connection(env('TENANT_DB_CONNECTION'))->table('products')->find($product_quotation->product_id);
                                                        ...
                                                        $customer = DB::connection(env('TENANT_DB_CONNECTION'))->table('customers')->find($lims_quotation_data->customer_id);

                                                        $customer_group = DB::connection(env('TENANT_DB_CONNECTION'))->table('customer_groups')->find($customer->customer_group_id);
                                                        ...
                                                        $tax = DB::connection(env('TENANT_DB_CONNECTION'))->table('taxes')->where('rate', $product_quotation->tax_rate)->first();
