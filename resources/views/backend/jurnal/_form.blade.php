                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @csrf
                            <div class="row">
                                <div data-form="header" class="col-md-4">
                                        ...
                                        <select required name="induk_transaksi" onchange="jenisTransaksi()"
                                            ...
                                            @foreach ($induk as $in)
                                                @php
                                                    $selected = '';
                                                    if (isset($jurnal)) {
                                                        if ($jurnal->tb_induk_jenis_transaksi_id == $in->id) {
                                                            $selected = 'selected';
                                                        }
                                                    } else {
                                                        if ($in->id == 8) {
                                ...
                                <div data-form="header" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_transaksi" required class="form-control date"
                                            value="{{ isset($jurnal) ? $jurnal->tgl_transaksi : date('d-m-Y') }}" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nama_barang" class="inv form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ isset($inventaris) ? $inventaris->unit : '' }}"
                                                name="unit" class="inv form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-align: right;"
                                                ...
                                                name="harga_satuan" class="inv form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="umur_ekonomis" class="inv form-control">
                                        </div>
                                    </div>
                                    @if (isset($inventaris))
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="inv form-control" name="status" id="status">
                                                    <option value="baik"
                                                        @if ($inventaris->status == 'baik') selected="" @endif>Baik</option>
                                                    <option value="rusak"
                                                        @if ($inventaris->status == 'rusak') selected="" @endif>Rusak</option>
                                                </select>
                                            </div>
                                        </div>
                                    @else
                                        <input type="hidden" name="status" id="status" value="baik">
                                    @endif
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Memo</label>
                                        <textarea name="memo" class="form-control" required style="min-height: 150px;">{{ isset($jurnal) ? $jurnal->memo : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-end" id="addRow">
                                        <button onclick="cloneAkun()" class="btn btn-success btn-sm" type="button">
                                            <i class="dripicons-plus"></i> Tambah Data
                                        </button>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <a href="{{ route('jurnal.index') }}" class="btn btn-danger">
                                            {{ trans('file.Cancel') }}
                                        </a>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function jenisTransaksi(id_jenis_transaksi = null) {
            var tb_induk_transaksi = $('#induk_transaksi').val()

            $('#addRow').find('button').attr('disabled', false);
            if (tb_induk_transaksi != '8') {
                $('#addRow').find('button').attr('disabled', true);
            }
            ...
            $.ajax({
                ...
                success: function(i) {
                    ...
                    if (tb_induk_transaksi != '8') {
                        ...
                        $('#jenis_transaksi').selectpicker();
                        $('div[data-form="header"]').attr('class', 'col-md-3');
                    } else {
                        ...
                        if (tb_induk_transaksi == '8') {
                            ...
                            $('#inventaris').hide();
                            $('.inv').prop('required', false);
                            $('div[data-form="header"]').attr('class', 'col-md-4');
                        }
                    }
                }
            });
