    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-end">
                <a href="{{ route('discounts.create') }}" class="btn btn-info">
                    <i class="dripicons-plus"></i> {{ trans('file.Create Discount Group') }}
                </a>
            </div>
                    ...
                    <tbody>
                        @foreach ($lims_discount_all as $key => $discount)
                            <tr data-id="{{ $discount->id }}">
                                ...
                                <td>{{ date($general_setting->date_format, strtotime($discount->valid_from)) . '-' . date($general_setting->date_format, strtotime($discount->valid_till)) }}
                                </td>
                                <td>{{ $discount->days }}</td>
                                <td>
                                    @if ($discount->product_list)
                                        <?php $products = \App\Product::select('name', 'code')
                                            ->whereIn('id', explode(',', $discount->product_list))
                                            ->get(); ?>
