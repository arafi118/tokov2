                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>{{ trans('file.Update Discount Group') }}</h4>
                        </div>
                        <div class="card-body">
                            <p class="italic">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="valid_from"
                                        value="{{ date($general_setting->date_format, strtotime($lims_discount_data->valid_from)) }}"
                                        required class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Valid Till') }} *</label>
                                    <input type="text" name="valid_till"
                                        value="{{ date($general_setting->date_format, strtotime($lims_discount_data->valid_till)) }}"
                                        required class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
