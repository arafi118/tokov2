                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tanggal Awal Pemakaian Aplikasi</label>
                                        <input type="text" name="tgl_awal_app" class="date form-control" value="{{\Carbon\Carbon::parse($lims_general_setting_data->tgl_awal_app)->format('d-m-Y')}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tahun Saldo Awal Tahun</label>
                                        <input type="text" name="tahun_saldo_awal_tahun" readonly class="form-control" value="{{$lims_general_setting_data->tahun_saldo_awal_tahun}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Bulan Saldo Awal Tahun</label>
                                        <input type="text" name="bulan_saldo_awal_tahun" readonly class="form-control" value="{{$lims_general_setting_data->bulan_saldo_awal_tahun}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tahun Saldo Bulan Lalu</label>
                                        <input type="text" name="tahun_saldo_bulan_lalu" readonly class="form-control" value="{{$lims_general_setting_data->tahun_saldo_bulan_lalu}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Bulan Saldo Bulan Lalu</label>
                                        <input type="text" name="bulan_saldo_bulan_lalu" readonly class="form-control" value="{{$lims_general_setting_data->bulan_saldo_bulan_lalu}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
