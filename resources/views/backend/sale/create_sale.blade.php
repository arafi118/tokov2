            ...
            <?php
              ...
              $due_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                    ...
                    ->where([
                      ...
                      ['role_id', $role->id] ])->first();
              $supplier_due_report_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            if($lims_sale_data->coupon_id)
                                $lims_coupon_data = DB::connection(env('TENANT_DB_CONNECTION'))->table('coupons')->find($lims_sale_data->coupon_id);
                        @endphp
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                <?php
                                                    $product_data = DB::connection(env('TENANT_DB_CONNECTION'))->table('products')->find($product_sale->product_id);
                                                    ...
                                                    $tax = DB::connection(env('TENANT_DB_CONNECTION'))->table('taxes')->where('rate',$product_sale->tax_rate)->first();
                                                    $unit_name = array();
                                                    $unit_operator = array();
