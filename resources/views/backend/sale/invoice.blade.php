    ...
    <div style="max-width:400px;margin:0 auto">
        ...
        <div class="hidden-print">
            <table>
                <tr>
                    <td>
                        <a href="{{ $url }}" class="btn btn-info"><i class="fa fa-arrow-left"></i>
                            {{ trans('file.Back') }}
                        </a>
                    </td>
                    <td>
            ...
            <table class="table-data">
                <tbody>
                    ...
                    @if ($lims_sale_data->shipping_cost)
                        <tr>
                            <th colspan="2" style="text-align:left">{{ trans('file.Shipping Cost') }}
                    ...
                    <tr>
                        @if ($general_setting->currency_position == 'prefix')
                            <th class="centered" colspan="3">
                                {{ trans('file.In Words') }}:
                                {{ $currency->id == '1' ? str_replace('-', ' ', $numberInWords) . ' ' . $currency->name : $currency->code . ' ' . str_replace('-', ' ', $numberInWords) }}
                            </th>
                        @else
                            <th class="centered" colspan="3">
                                {{ trans('file.In Words') }}:
                    ...
                    @foreach ($lims_payment_data as $payment_data)
                        <tr style="background-color:#ddd;">
                            ...
                            <td style="padding: 5px;width:30%">{{ trans('file.Change') }}:
                                {{ number_format((float) $payment_data->change, 2, '.', '') }}
                            </td>
                        </tr>
                    @endforeach
                    <tr>
