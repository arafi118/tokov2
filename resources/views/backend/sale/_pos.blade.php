...
@section('content')
    ...
    <nav class="side-navbar shrink">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
            ...
            $print_barcode_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $stock_count_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $adjustment_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="product" class="collapse list-unstyled ">
                    ...
                    @if ($index_permission_active)
                        ...
                        $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                            ->table('role_has_permissions')
            ...
            $gift_card_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $coupon_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $money_transfer_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $balance_sheet_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $account_statement_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $department_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $index_employee_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $attendance_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            $payroll_active = DB::connection(env('TENANT_DB_CONNECTION'))
                ->table('role_has_permissions')
            ...
            <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="people" class="collapse list-unstyled ">
                    <?php $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('permissions')
                    ...
                    @if ($index_permission_active)
                        ...
                        <?php $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                            ->table('permissions')
                            ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
            ...
            <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <?php
                $profit_loss_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'profit-loss'], ['role_id', $role->id]])
                    ->first();
                $best_seller_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'best-seller'], ['role_id', $role->id]])
                    ->first();
                $warehouse_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'warehouse-report'], ['role_id', $role->id]])
                    ->first();
                $warehouse_stock_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'warehouse-stock-report'], ['role_id', $role->id]])
                    ->first();
                $product_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'product-report'], ['role_id', $role->id]])
                    ->first();
                $daily_sale_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'daily-sale'], ['role_id', $role->id]])
                    ->first();
                $monthly_sale_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'monthly-sale'], ['role_id', $role->id]])
                    ->first();
                $daily_purchase_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'daily-purchase'], ['role_id', $role->id]])
                    ->first();
                $monthly_purchase_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'monthly-purchase'], ['role_id', $role->id]])
                    ->first();
                $purchase_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'purchase-report'], ['role_id', $role->id]])
                    ->first();
                $sale_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'sale-report'], ['role_id', $role->id]])
                    ->first();
                $sale_report_chart_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'sale-report-chart'], ['role_id', $role->id]])
                    ->first();
                $payment_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'payment-report'], ['role_id', $role->id]])
                    ->first();
                $product_qty_alert_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'product-qty-alert'], ['role_id', $role->id]])
                    ->first();
                $dso_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'dso-report'], ['role_id', $role->id]])
                    ->first();
                $user_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'user-report'], ['role_id', $role->id]])
                    ->first();
                
                $customer_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'customer-report'], ['role_id', $role->id]])
                    ->first();
                $supplier_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'supplier-report'], ['role_id', $role->id]])
                    ->first();
                $due_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([['permissions.name', 'due-report'], ['role_id', $role->id]])
                    ->first();
                $supplier_due_report_active = DB::connection(env('TENANT_DB_CONNECTION'))
                    ->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                ...
                <ul id="setting" class="collapse list-unstyled ">
                    <?php
                    $all_notification_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([['permissions.name', 'all_notification'], ['role_id', $role->id]])
                        ->first();
                    $send_notification_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ...
                    $warehouse_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $customer_group_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $brand_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $unit_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $tax_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $general_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $mail_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $sms_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $create_sms_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $pos_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $hrm_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                    ...
                    $reward_point_setting_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('role_has_permissions')
                        ->where([['permission_id', $reward_point_setting_permission->id], ['role_id', $role->id]])
                        ->first();
                    $discount_plan_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([['permissions.name', 'discount_plan'], ['role_id', $role->id]])
                        ->first();
                    $discount_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                        ->table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ...
                    <div class="card">
                        <div class="card-body" style="padding-bottom: 0">
                            ...
                            @php
                                ...
                                $customer_active = DB::connection(env('TENANT_DB_CONNECTION'))
                                    ->table('permissions')
                                    ->join(
                        ...
                        <nav class="navbar">
                            ...
                            <div class="navbar-header">
                                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                    ...
                                    $today_sale_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                                        ->table('role_has_permissions')
                                    ...
                                    $today_profit_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))
                                        ->table('role_has_permissions')
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    @foreach ($recent_draft as $draft)
                                                        <?php $customer = DB::connection(env('TENANT_DB_CONNECTION'))
                                                            ->table('customers')
                                                            ->find($draft->customer_id); ?>
                                                        <tr>
        ...
        $("#print-btn").on("click", function() {
            ...
            newWin.document.write(
                '<link rel="stylesheet" href="<?php echo asset('
                                                                            ...
                                                                            .css '); ?>" type="text/css"><style type="text/css">@media print {.modal-dialog { max-width: 1000px;} }</style><body onload="window.print()">' +
