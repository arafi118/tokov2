    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">                  
          ...
          @endif
          <?php 
            $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'sales-index')->first();
            $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
          ...
          <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-return"></i><span>{{trans('file.return')}}</span></a>
            <ul id="return" class="collapse list-unstyled ">
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'returns-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'purchase-return-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
          ...
          <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user"></i><span>{{trans('file.People')}}</span></a>
            <ul id="people" class="collapse list-unstyled ">
              <?php $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
              ...
              <?php $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'customers-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php 
                $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'customers-add')->first();
                $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'billers-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php 
                $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'billers-add')->first();
                $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              @endif
              <?php 
                $index_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'suppliers-index')->first();
                $index_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              <?php 
                $add_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'suppliers-add')->first();
                $add_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                    ['permission_id', $add_permission->id],
                    ['role_id', $role->id]
                ])->first();
                ...
                <div class="card">
                    <div class="card-body" style="padding-bottom: 0">
                        ...
                        @php
                            ...
                            $customer_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')
                              ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                              ->where([
                      ...
                      <div class="container-fluid">
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <?php
                                $today_sale_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'today_sale')->first();
                                $today_sale_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                                            ['permission_id', $today_sale_permission->id],
                                            ['role_id', Auth::user()->role_id]
                                        ])->first();

                                $today_profit_permission = DB::connection(env('TENANT_DB_CONNECTION'))->table('permissions')->where('name', 'today_profit')->first();
                                $today_profit_permission_active = DB::connection(env('TENANT_DB_CONNECTION'))->table('role_has_permissions')->where([
                              ...
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <?php $customer = DB::connection(env('TENANT_DB_CONNECTION'))->table('customers')->find($sale->customer_id); ?>
                                    <tr>
                              ...
                              <div class="table-responsive">
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <?php $customer = DB::connection(env('TENANT_DB_CONNECTION'))->table('customers')->find($draft->customer_id); ?>
                                    <tr>
