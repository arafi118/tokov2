                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <?php
                                                        $product_data = DB::connection(env('TENANT_DB_CONNECTION'))->table('products')->find($product_transfer->product_id);
                                                        ...
                                                        $tax = DB::connection(env('TENANT_DB_CONNECTION'))->table('taxes')->where('rate', $product_transfer->tax_rate)->first();
