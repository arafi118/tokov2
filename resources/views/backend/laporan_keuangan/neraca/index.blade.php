    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">Neraca</h3>
            </div>
            @include('backend.laporan_keuangan.filter')
            <div class="row" style="margin:10px;">
            	<div class="col-md-12">
            		@if($tahun !='' && $bulan !='')
            		@include('backend.laporan_keuangan.neraca.table')
					@else
...
function doFilter(param=null){
	var is_param = '';
	var url ='{{url("laporan_keuangan/neraca?warehouse_id")}}='+$('#warehouse_id').val()+'&tahun='+$('#tahun').val()+'&bulan='+$('#bulan').val()+'&hari='+$('#hari').val();
