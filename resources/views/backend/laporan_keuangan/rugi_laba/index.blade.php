    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="row" style="margin:10px;">
            	<div class="col-md-12">
            		@if($tahun !='' && $bulan !='')
            		@include('backend.laporan_keuangan.rugi_laba.table')
					@else
...
function doFilter(param=null){
	var is_param = '';
	var url ='{{url("laporan_keuangan/rugi_laba?warehouse_id")}}='+$('#warehouse_id').val()+'&tahun='+$('#tahun').val()+'&bulan='+$('#bulan').val()+'&hari='+$('#hari').val();
