    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">Neraca Saldo</h3>
            </div>
...
function doFilter(param=null){
	var is_param = '';
	var url ='{{url("laporan_keuangan/neraca_saldo?warehouse_id")}}='+$('#warehouse_id').val()+'&tahun='+$('#tahun').val()+'&bulan='+$('#bulan').val()+'&hari='+$('#hari').val();
