            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 @if (\Auth::user()->role_id > 2) {{ 'd-none' }} @endif">
                            <div class="form-group">
                    ...
                    @if (in_array('purchase-return-add', $all_permission))
                        <div class="d-flex justify-content-end mt-3">
                            <a href="#" data-toggle="modal" data-target="#add-purchase-return" class="btn btn-info">
                                <i class="dripicons-plus"></i> {{ trans('file.Add Return') }}
                            </a>
                        </div>
                    @endif
    ...
    <script type="text/javascript">
        ...
        function returnDetails(returns) {
            ...
            var htmltext = '<strong>{{ trans('file.Date') }}: </strong>' + returns[0] +
                ...
                '<br><strong>{{ trans('file.Purchase Reference') }}: </strong>' + returns[22] +
                ...
                returns[5] + '<br>' + returns[6] + '<br>' + returns[7] + '<br>' + returns[8] + '<br>' + returns[9] + ', ' +
            ...
            var htmlfooter = '<p><strong>{{ trans('file.Return Note') }}:</strong> ' + returns[18] +
                ...
                '</p><strong>{{ trans('file.Created By') }}:</strong><br>' + returns[20] + '<br>' + returns[21];
