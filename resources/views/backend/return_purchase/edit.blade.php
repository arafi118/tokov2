                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open([
                                'route' => ['return-purchase.update', $lims_return_data->id],
                                'method' => 'put',
                                'files' => true,
                                'class' => 'payment-form',
                            ]) !!}
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($lims_product_return_data as $product_return)
                                                            <tr>
                                                                <?php
                                                                $product_data = DB::connection(env('TENANT_DB_CONNECTION'))->table('products')->find($product_return->product_id);
                                                                ...
                                                                $tax = DB::connection(env('TENANT_DB_CONNECTION'))->table('taxes')->where('rate', $product_return->tax_rate)->first();
                                                                $unit_name = [];
                                                                $unit_operator = [];
                                                                ...
                                                                <td class="net_unit_cost">
                                                                    {{ number_format((float) $product_return->net_unit_cost, 2, '.', '') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_return->discount, 2, '.', '') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_return->tax, 2, '.', '') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format((float) $product_return->total, 2, '.', '') }}
                                                                </td>
                                                                ...
                                                                <input type="hidden" name="product_id[]"
                                                                    class="product-id" value="{{ $product_data->id }}" />
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_return_data->total_discount, 2, '.', '') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_return_data->total_tax, 2, '.', '') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_return_data->total_cost, 2, '.', '') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
