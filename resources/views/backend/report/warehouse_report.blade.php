                ...
                <table id="purchase-table" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key}}</td>
                            <?php
                                $supplier = DB::connection(env('TENANT_DB_CONNECTION'))->table('suppliers')->find($purchase->supplier_id);
                            ?>
                ...
                <table id="quotation-table" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key}}</td>
                            <?php
                                $supplier = DB::connection(env('TENANT_DB_CONNECTION'))->table('suppliers')->find($quotation->supplier_id);
                            ?>
