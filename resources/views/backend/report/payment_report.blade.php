    ...
    <div class="table-responsive mb-4">
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                ...
                <?php
                    $sale = DB::connection(env('TENANT_DB_CONNECTION'))->table('sales')->find($payment->sale_id);
                    $purchase = DB::connection(env('TENANT_DB_CONNECTION'))->table('purchases')->find($payment->purchase_id);
                    $user = DB::connection(env('TENANT_DB_CONNECTION'))->table('users')->find($payment->user_id);
                ?>
                <tr>
                    <td></td>
