    ...
    <div class="table-responsive mb-4">
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                ...
                <?php
                    $customer = DB::connection(env('TENANT_DB_CONNECTION'))->table('customers')->find($sale_data->customer_id);
                    $returned_amount = DB::connection(env('TENANT_DB_CONNECTION'))->table('returns')->where('sale_id', $sale_data->id)->sum('grand_total');
                ?>
                <tr>
                    <td>{{$key}}</td>
