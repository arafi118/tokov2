                        ...
                        <div class="card-body">
                            ...
                            <form id="product-form">
                                ...
                                <div class="row">
                                    ...
                                    <ul class="col-md-12 list-group mt-3">
                                        <li class="list-group-item" id="diffPrice-option">
                                            <label for="is-diffPrice" class="font-weight-bold">
                                                <input name="is_diffPrice" type="checkbox" id="is-diffPrice"
                                                    value="1"
                                                    {{ $lims_product_data->is_diffPrice ? 'checked' : '' }}>
                                        ...
                                        <li class="list-group-item" id="batch-option">
                                            <label for="is-batch" class="font-weight-bold">
                                                <input name="is_batch" type="checkbox" id="is-batch" value="1"
                                                    {{ $lims_product_data->is_batch ? 'checked' : '' }}>
                                                {{ trans('file.This product has batch and expired date') }}
                                            </label>
                                        </li>
                                        <li class="list-group-item" id="imei-option">
                                            <label for="is-imei" class="font-weight-bold">
                                                <input name="is_imei" type="checkbox" id="is-imei" value="1"
                                                    {{ $lims_product_data->is_imei ? 'checked' : '' }}>
                                                {{ trans('file.This product has IMEI or Serial numbers') }}
                                            </label>
                                        </li>
                                        <li class="list-group-item" id="variant-option">
                                            <label for="is-variant" class="font-weight-bold">
                                                <input name="is_variant" type="checkbox" id="is-variant" value="1"
                                                    {{ $lims_product_data->is_variant ? 'checked' : '' }}>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <label for="promotion" class="font-weight-bold">
                                        ...
                                        <li class="list-group-item">
                                            <label for="is-embeded" class="font-weight-bold">
                                                <input type="checkbox" id="is-embeded" name="is_embeded" value="1"
                                                    {{ $lims_product_data->is_embeded ? 'checked' : '' }}>
                                                {{ trans('file.Embedded Barcode') }}
                                                <i class="dripicons-question" data-toggle="tooltip"
                                                    title="{{ trans('file.Check this if this product will be used in weight scale machine.') }}"></i>
                                            </label>
                                        </li>
                                    </ul>
