                ...
                <tr>
                    ...
                    <td>
                        @if($stock_count->category_id)
                            ...
                            @php
                                $category = \DB::connection(env('TENANT_DB_CONNECTION'))->table('categories')->find($category_id);
                    ...
                    <td>
                        @if($stock_count->brand_id)
                            ...
                            @php
                                $brand = \DB::connection(env('TENANT_DB_CONNECTION'))->table('brands')->find($brand_id);
