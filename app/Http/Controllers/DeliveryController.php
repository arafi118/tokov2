...
class DeliveryController extends Controller
{
    ...
    public function create($id){
        ...
        if($lims_delivery_data){
            $customer_sale = DB::connection(env('TENANT_DB_CONNECTION'))->table('sales')->join('customers', 'sales.customer_id', '=', 'customers.id')->where('sales.id', $id)->select('sales.reference_no','customers.name')->get();
            ...
            $customer_sale = DB::connection(env('TENANT_DB_CONNECTION'))->table('sales')->join('customers', 'sales.customer_id', '=', 'customers.id')->where('sales.id', $id)->select('sales.reference_no','customers.name', 'customers.address', 'customers.city', 'customers.country')->get();
    ...
    {
        $lims_delivery_data = Delivery::find($id);
        $customer_sale = DB::connection(env('TENANT_DB_CONNECTION'))->table('sales')->join('customers', 'sales.customer_id', '=', 'customers.id')->where('sales.id', $lims_delivery_data->sale_id)->select('sales.reference_no','customers.name')->get();
